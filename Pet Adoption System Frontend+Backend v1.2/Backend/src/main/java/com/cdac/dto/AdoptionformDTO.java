...
public class AdoptionformDTO {
	...
	public AdoptionformDTO(int formNo, String adoptionReason, double annualIncome, String applicantGender,
			String biologicalChildren, int petId, String companyDetails, String nationality, String occupation,
	...
	public void setChildId(int petId) {
		this.petId = petId;
	}
	...
	public String toString() {
		return "AdoptionformDTO [adoptionReason=" + adoptionReason + ", annualIncome=" + annualIncome
				...
				+ petId + ", companyDetails=" + companyDetails + ", nationality=" + nationality + ", occupation="
