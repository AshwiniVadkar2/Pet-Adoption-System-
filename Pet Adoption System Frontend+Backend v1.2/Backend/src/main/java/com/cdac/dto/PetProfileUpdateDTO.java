...
public class PetProfileUpdateDTO {
	...
	public PetProfileUpdateDTO() {
		// TODO Auto-generated constructor stub
	}

	public PetProfileUpdateDTO(int age, String bloodGroup, String colourComplexity, String deficiency,
	...
	public String toString() {
		return "PetProfileUpdateDTO [age=" + age + ", bloodGroup=" + bloodGroup + ", colourComplexity="
	...
	public static PetProfileUpdateDTO fromEntity(PetDetails entity) {
		PetProfileUpdateDTO dto = new PetProfileUpdateDTO();
		BeanUtils.copyProperties(entity, dto);
		return dto;
	}

	public static PetDetails toEntity(PetProfileUpdateDTO dto, User user) {
