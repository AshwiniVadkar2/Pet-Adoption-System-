...
//	}
	...
	public DocumentMaster saveDocument(int id, DocumentMaster doc, MultipartFile addressProof,
	                                   MultipartFile identityProof, MultipartFile incomeProof, MultipartFile nationalityCertificate,
	                                   MultipartFile nonCriminal_certificate) {
	    // Log filenames to verify different files are being processed
	    System.out.println("Address Proof: " + addressProof.getOriginalFilename());
	    System.out.println("Identity Proof: " + identityProof.getOriginalFilename());
	    System.out.println("Income Proof: " + incomeProof.getOriginalFilename());
	    System.out.println("Nationality Certificate: " + nationalityCertificate.getOriginalFilename());
	    System.out.println("Non-Criminal Certificate: " + nonCriminal_certificate.getOriginalFilename());
