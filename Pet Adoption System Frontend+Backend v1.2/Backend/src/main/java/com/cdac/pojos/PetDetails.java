...
public class PetDetails {
	...
	public PetDetails(int petId, int age, String bloodGroup, String colourComplexity, String deficiency,
	...
	public String toString() {
		return "petDetails [petId=" + petId + ", age=" + age + ", bloodGroup=" + bloodGroup
