...
import Addpet from './components/pages/Dashboard/AdminFunc/Addpet'
import AdminViewPets from './components/pages/Dashboard/AdminFunc/AdminViewPets'
import Pets from './components/pages/Dashboard/AdminFunc/Pets'
import DeletePet from './components/pages/Dashboard/AdminFunc/DeletePet'
import EditPetProfile from './components/pages/Dashboard/AdminFunc/EditPetProfile'
import ParentViewPets from './components/pages/Dashboard/ParentFunc/ParentViewPets'
function App() {
  return (
    <Router>
    <div className="App">
      <Switch>
        ...
        {/* <Route exact path="/editchildprofile/:petId" component={EditPetProfile} /> */}
        <Route exact path="/editpetprofile/:petId" component={EditPetProfile} />
        {/* <Route exact path="/deletechild" component={DeletePet} /> */}
        <Route exact path="/deletepet" component={DeletePet} />
        

        <Route exact path="/add-new-admin" component={AddNewAdmin} />


        {/* <Route exact path="/aviewchilds" component={Pets} /> */}
        <Route exact path="/adminviewpets" component={Pets} />
        {/* <Route exact path="/pviewchilds" component={ParentViewPets} /> */}
        <Route exact path="/parentviewpets" component={ParentViewPets} />
        {/* <Route exact path="/aviewchild" component={AdminViewPets} /> */}
        <Route exact path="/adminviewpet" component={AdminViewPets} />


        {/* <Route exact path="/addchilddetails" component={Addpet} /> */}
        <Route exact path="/addpetdetails" component={Addpet} />
