              ...
              <div class="row">
                <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                  <h5 class="text-uppercase text-color">
                    FurEver Pet Adoption System Project
                  </h5>

                  <p className="d-flex justify-content-center align-items-center">
                  A Pet Adoption System We are dedicated to giving homeless animals a second chance at life.
Through love, care, and responsible adoption, we connect pets with families where they can truly belong.
                  </p>
                </div>
